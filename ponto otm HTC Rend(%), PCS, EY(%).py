{
  ...
  "metadata": {
    "colab": {
      ...
      "provenance": [],
      "collapsed_sections": [],
      "authorship_tag": "ABX9TyNFRmYikoKH+xD1/gyvrpHG",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/costagean/Redes_Neurais/blob/main/ponto%20otm%20HTC%20Rend(%25)%2C%20PCS%2C%20EY(%25).py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "metadata": {
        ...
        "id": "hKOOCe3N5s1g",
        "outputId": "9ddf59a8-5390-4155-8d75-2442922da042"
      },
      "source": [
        "import numpy as np\n",
        "\n",
        ...
        "y3_maxi = 21.21202 - 2.03192 * (x1) - 0.64099 * (x1) * (x1) - 0.55117 * (x2) - 0.24608 * (x3)\n",
        "\n",
        ...
        "y3_mini = 21.21202 - 2.03192 * (x1) - 0.64099 * (x1) * (x1) - 0.55117 * (x2) - 0.24608 * (x3)\n",
        "\n",
        "x1_maxi_y1 = 0\n",
        "x2_maxi_y1 = 0\n",
        "\n",
        ...
        "            y3 = 21.21202 - 2.03192 * (x1) - 0.64099 * (x1) * (x1) - 0.55117 * (x2) - 0.24608 * (x3)\n",
        "\n",
        "            if y1>y1_maxi:\n",
        "                y1_maxi = y1\n",
        "                x1_maxi_y1 = x1\n",
      ...
      "outputs": [
        {
          ...
          "text": [
            ...
            "=============================================================================================\n",
            " maximo de y3 eh de 23.79 com x1 de -1.29, x2 de -1.29 e x3 de -1.29\n",
            " minimo de y3 eh de 16.51 com x1 de 1.29, x2 de 1.29 e x3 de 1.29\n",
            "=============================================================================================\n",
            "=============================================================================================\n",
            " A desejabilidade foi 0.85 com x1 de -1.29, x2 de 0.11 e x3 de -1.29\n",
            " y1 com valor de 63.62\n",
            " y2 com valor de 66.51\n",
            " y3 com valor de 23.02\n"
          ]
        }
      ]
    }
